      ...
      <p className="mt-1 text-xl text-slate-600 font-semibold">{appsMetrics?.kpis[1].value} Users Engaged</p>
            ...
            <section>
              <div className="mb-3 flex items-center gap-3">
                ...
                <Button onClick={() => router.push('/dashboard/create')} className="inline-flex items-center gap-2 border-2  bg-[#8759FF] px-3 py-2 text-sm font-medium text-white hover:bg-indigo-700">
