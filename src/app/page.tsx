...
`}</style>
    <div className="  center-fade-bg bg-gradient-to-br  flex  justify-center px-4 py-10">
  ...
  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-24 w-full h-[800px] pointer-events-none">
    <div className="w-full h-full bg-gradient-to-t to-transparent blur-3xl"></div>
          ...
          <div className="relative z-10 hover:scale-105 transition-all duration-300">
            <Image src="images/hero.svg" alt="heroimage"                 height={500} 
                width={638}/>
          </div>
        </div>
        ...
        {/* Main Heading */}
        <div className="mb-10">
          <p className=" md:text-6xl  lg:text-5xl font-semibold text-gray-950 mb-6">
            The Web3 Super App.
          </p>
        ...
        {/* CTA Button */}
        <div>
          <button onClick={() => router.push('/register')} className="bg-[#8759FF] hover:bg-purple-700 text-white font-semibold py-4 px-8  text-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            Join
          </button>
        </div>
      </div>
